...
const Input = ({ id, type, label, disabled, required, register, errors, formatprice, ...props }: InputProps) => {
  return (
    <div className="relative w-full">
      {formatprice && <span className="absolute top-[18px] left-3">￦</span>}
      <input
        id={id}
        type={type}
        disabled={disabled}
